...
map_to="$lin/maps/maze/maze_p02_01.map"
...
map=to)
	echo "Running a map which took timeout $map_to"
	./$lin/playgame.py --log_dir $lin/game_logs -So --verbose --engine_seed 42 --player_seed 0 --turns 1000 --map_file $map_to $player1 "python $player2"|java -jar $lin/visualizer.jar;;
